...
#     'Group3': {
#         'years': year[38:55],
#         'political_rights': pr[38:55],
#         'internet_Filtering': y221p[38:55],
#     },
#     'Group4': {
#         'years': year[57:74],
#         'political_rights': pr[57:74],
#         'internet_Filtering': y221p[57:74],
#     }
}
...
#     'Group3': {
#         'years': year[38:55],
#         'democracy_index': eiu[38:55],
#         'internet_Filtering': y221[38:55],
#     },
#     'Group4': {
#         'years': year[57:74],
#         'democracy_index': eiu[57:74],
#         'internet_Filtering': y221[57:74],
#     }
}
...
#         'years': year[38:55],
#         'political_rights': pr[38:55],
#         'internet_shut_down': y223p[38:55],
#     },
#     'Group4': {
#         'years': year[57:74],
#         'political_rights': pr[57:74],
#         'internet_shut_down': y223p[57:74],
#     }
 }
...
#         'years': year[38:55],
#         'democracy_index': eiu[38:55],
#         'internet_shut_down': y223[38:55],
#     },
#     'Group4': {
#         'years': year[57:74],
#         'democracy_index': eiu[57:74],
#         'internet_shut_down': y223[57:74],
#     }
}
...
#         'years': year[38:55],
#         'political_rights': pr[38:55],
#         'cyber_security_capacity': y229p[38:55],
#     },
#     'Group4': {
#         'years': year[57:74],
#         'political_rights': pr[57:74],
#         'cyber_security_capacity': y229p[57:74],
#     }
}
...
#         'years': year[38:55],
#         'democracy_index': eiu[38:55],
#         'cyber_security_capacity': y229[38:55],
#     },
#     'Group4': {
#         'years': year[57:74],
#         'democracy_index': eiu[57:74],
#         'cyber_security_capacity': y229[57:74],
#     }
}
...
colors = {
    ...
    'Group2': 'Reds',  # Height-scoring group
#    'Group3': 'Greens',
#    'Group4': 'Reds'
}
...
# axs[0, 0].set_xlim(-2, 1.25)
# axs[0, 0].set_ylim(-0.95,0.8)
...
# axs[1, 0].set_xlim(-2, 1.25)
# axs[1, 0].set_ylim(-0.95,0.8)
axs[1, 0].grid(True)
...
# axs[2, 0].set_xlim(-2, 1.25)
# axs[2, 0].set_ylim(-0.95,0.8)
axs[2, 0].grid(True)
...
# axs[2, 1].set_xlim(-0.35,0.15)
# axs[2, 1].set_ylim(-0.7,0.9)
axs[2, 1].grid(True)

plt.tight_layout()
fig.savefig('Figure2.pdf', dpi=800)
...
plt.ylabel("Internet Shut Down Capacity")
plt.xlim(-2, 1.2)
plt.ylim(-0.95,0.8)
#plt.title("Political Rights vs Internet Shut Down Capacity (2006-2023)")
