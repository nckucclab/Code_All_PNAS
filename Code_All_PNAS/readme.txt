...
Stata Code "FigureC.do" is used for Figure C 
      ...
      Then, run Python code "Figure A1.py" in the fold "Figures2_A1" to generate Figure C.
...
Stata Code "Table_C_SR.do" is used to report Governments’ Technological Capacities for Various Democracy Groups in Table C in Appendix C of Supporting Information A.
...
In the fold "Population Adjustemnt", there are the stata data and do files used to generate Tables D.1 to D.4 in Appendix D of Supporting Information A, including 
    ...
    Table2_pop.do: for Table D.1    
    Table3_pop.do: for Table D.2
    Table2_pop_2.do: for Table D.3
    Table3_pop_2.do: for Table D.4  
